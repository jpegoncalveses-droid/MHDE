...
SCHEMA_CRYPTO_UNIVERSE_RANKING_BUFFER = """
CREATE TABLE IF NOT EXISTS crypto_universe_ranking_buffer (
    symbol VARCHAR NOT NULL,
    ranking_date DATE NOT NULL,
    avg_daily_volume_30d DOUBLE,
    rank_by_volume INTEGER NOT NULL,
    in_top_50 BOOLEAN NOT NULL,
    PRIMARY KEY (symbol, ranking_date)
);
"""

SCHEMA_CRYPTO_UNIVERSE_PENDING = """
CREATE TABLE IF NOT EXISTS crypto_universe_pending (
    symbol VARCHAR NOT NULL,
    days_listed INTEGER NOT NULL,
    eligible_after_date DATE NOT NULL,
    consecutive_top_50 INTEGER NOT NULL,
    last_checked_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (symbol)
);
"""

SCHEMA_SENTIMENT_FEAR_GREED = """
...
SCHEMA_SENTIMENT_FUNDING_UNIVERSE = """
...
SCHEMA_SENTIMENT_FUNDING_AGGREGATE = """
