...
**Status:** PROPOSED — design spec for operator review. **No implementation, no code.** The
firehose stays **parked** until this is accepted, the PRs land, and the §G measured trial passes.
