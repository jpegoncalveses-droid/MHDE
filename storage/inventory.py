...
TABLE_CATALOG: dict[str, dict] = {
    ...
    "filings": {
        ...
        "freshness": "daily",
        "consumers": ["features/catalyst.py", "health/operational.py", "ingestion/ingest_sec.py"],
    },
    "fundamentals_raw": {
    ...
    "scores": {
        ...
        "freshness": "each pipeline run",
        "consumers": ["pipelines/daily_radar.py", "review/packet_builder.py", "health/operational.py", "missed/catalyst_queue.py"],
    },
    "hypotheses": {
